...
function Stat({ label, value, accent }: { label: string; value: string; accent?: boolean }) {
  return (
    <div className="rounded-xl bg-paper/50 p-3 ring-1 ring-line">
      ...
      <div className={`mt-1 font-display tnum text-lg ${accent ? "text-gold" : "text-ink"}`}>
        {value}
    ...
    <section className="mb-7 rounded-2xl bg-surface p-5 ring-1 ring-line">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2 text-[13px]">
        ...
        <input
          type="text"
          inputMode="decimal"
          className="w-16 bg-transparent border-b border-line pb-1 font-display text-lg tnum text-ink outline-none focus:border-gold"
          value={returnStr}
      ...
      <div className="mt-4 border-t border-line pt-4">
        <label className="flex flex-wrap items-baseline gap-x-2 gap-y-1 text-[13px]">
          ...
          <input
            type="text"
            inputMode="numeric"
            className="w-24 bg-transparent border-b border-line pb-1 font-display text-lg tnum text-ink outline-none focus:border-gold"
